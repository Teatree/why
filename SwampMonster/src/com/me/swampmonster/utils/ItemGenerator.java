...
//		itemTypeParams.put(1, OXYGEN);
		...
		items.put(0, null);
		items.put(1, Oxygen.class);
		items.put(2, HealthKit.class);
		items.put(3, FADE.class);
		items.put(4, CHAIN_ARROWS.class);
		items.put(5, HASTE.class);
		items.put(6, ICE_THING.class);
		items.put(7, NUKE.class);
		items.put(8, RADIOACTIVE.class);
	}
