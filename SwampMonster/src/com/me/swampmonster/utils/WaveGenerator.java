...
public class WaveGenerator {
	...
	private enum WaveParams{
		...
		p0_500(0, 3, 1, 5, 10, 12, 5, 6, 8, 9, 3.0f, 50, 3, 4),
		p0_500_Elite(0, 3, 1, 5, 10, 12, 5, 6, 5, 6, 3.0f, 50, 3, 4),
		p0_500_A(4, 5, 1, 5, 10, 12, 5, 6, 4, 6, 3.0f, 50, 3, 4),
		p500_1000(0, 3, 0, 7, 12, 14, 6, 8, 9, 11, 2.5f, 50, 6, 8),
		p500_1000_Elite(1, 3, 0, 7, 12, 14, 6, 8, 9, 11, 2.5f, 50, 6, 8),
		p500_1000_A(1, 3, 0, 7, 13, 14, 6, 8, 9, 11, 2.5f, 50, 6, 8),
		p1000_2000(0, 3, 0, 5, 14, 16, 6, 8, 10, 12, 2.0f, 50, 5, 6),
		p1000_2000_Elite(0, 3, 0, 5, 14, 16, 6, 8, 10, 12, 2.0f, 50, 5, 6),
		p1000_2000_A(0, 3, 0, 5, 14, 16, 6, 8, 10, 12, 2.0f, 50, 5, 6),
		p2000_4000(0, 4, 0, 5, 10, 12, 6, 9, 8, 10, 1.0f, 50, 5, 7),
		p2000_4000_Elite(0, 4, 0, 5, 10, 12, 6, 9, 8, 10, 1.0f, 50, 5, 7),
		p2000_4000_A(0, 4, 0, 5, 10, 12, 6, 9, 8, 10, 1.0f, 50, 5, 7);
